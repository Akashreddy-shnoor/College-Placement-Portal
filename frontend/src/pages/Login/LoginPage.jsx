    ...
    try {
      ...
      if (response.ok) {
        ...
        const sessionUser = {
          role: data.role,
          ...(data.role === 'admin'
            ? { username: 'college', name: data.userData.name, email: data.userData.email }
            : data.userData
          )
        };
      ...
      <div className="login-card-container">
        <div className="login-card glass-card">
          ...
          <div className="login-card-header">
            ...
            <h2>Placement <span className="gradient-text">Portal</span></h2>
            <p>Enter your credentials to enter the AI gateway</p>
          </div>
